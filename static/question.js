...

{
    ...
    options: ["ServMay choose the test you prefere", "May choose the test you prefer", "May refuse if underage", "Must take the test, or your license will be suspended" ],
    answer: 3
},
